Public Class clsCallibrationMaster
...
#End Region
    ...
    Sub CreateForm()
        Try
            objMain.objUtilities.LoadForm("Callibration Master.xml", "VSP_FLT_CALMSTR_Form", ResourceType.Embeded)
            objForm = objMain.objApplication.Forms.GetForm("VSP_FLT_CALMSTR_Form", objMain.objApplication.Forms.ActiveForm.TypeCount)
            objForm.Freeze(True)

            oDBs_Head = objForm.DataSources.DBDataSources.Item("@VSP_FLT_CALMSTR")
    ...
    Sub SetDefault(ByVal FormUID As String)
        Try
            ...
            oDBs_Head = objForm.DataSources.DBDataSources.Item("@VSP_FLT_CALMSTR")
            oDBs_Head.SetValue("Code", oDBs_Head.Offset, objMain.objUtilities.getMaxCode("@VSP_FLT_CALMSTR"))
    ...
    Sub MenuEvent(ByRef pVal As SAPbouiCOM.MenuEvent, ByRef BubbleEvent As Boolean)
        Try
            If pVal.MenuUID = "VSP_FLT_CALMSTR" And pVal.BeforeAction = False Then
