...
Public Class clsTyreMaintenance
#Region "        Declaration        "
    Dim objForm As SAPbouiCOM.Form
    Dim oDBs_Head, oDBs_Details2, oDBs_Details3 As SAPbouiCOM.DBDataSource
...
#End Region
    ...
    Sub CreateForm()
        Try
            objMain.objUtilities.LoadForm("Tyre Maintenance.xml", "VSP_FLT_TYRMTNC_Form", ResourceType.Embeded)
            objForm = objMain.objApplication.Forms.GetForm("VSP_FLT_TYRMTNC_Form", objMain.objApplication.Forms.ActiveForm.TypeCount)
            objForm.Freeze(True)

            oDBs_Head = objForm.DataSources.DBDataSources.Item("@VSP_FLT_TYRMTNC")
            oDBs_Details2 = objForm.DataSources.DBDataSources.Item("@VSP_FLT_TYRMTNC_C1")
            oDBs_Details3 = objForm.DataSources.DBDataSources.Item("@VSP_FLT_TYRMTNC_C2")
    ...
    Sub SetDefault(ByVal FormUID As String)
        Try
            ...
            oDBs_Head.SetValue("DocNum", oDBs_Head.Offset, objMain.objUtilities.GetNextDocNum(objForm, "VSP_FLT_OTYRMTNC"))
            ...
            Select Case pVal.EventType
                ...
                Case SAPbouiCOM.BoEventTypes.et_ITEM_PRESSED
                    ...
                    If pVal.ItemUID = "22" And pVal.BeforeAction = False And pVal.FormMode = SAPbouiCOM.BoFormMode.fm_OK_MODE Then
                        'objMain.objDocumentType.CreateForm(objForm.UniqueID, objForm.Items.Item("10").Specific.Value, "Tyre Maintenance")
                        objMain.objDocumentType.CreateForm(objForm.UniqueID, objForm.Items.Item("10").Specific.Value, "Tyre Maintenance")
                    End If
                ...
                Case SAPbouiCOM.BoEventTypes.et_FORM_ACTIVATE
                    ...
                    If pVal.BeforeAction = False And pVal.FormMode = SAPbouiCOM.BoFormMode.fm_OK_MODE Then
                        ...
                        objMain.objUtilities.RefreshDatasourceFromDB(FormUID, objForm.DataSources.DBDataSources.Item("@VSP_FLT_TYRMTNC"), "DocEntry", oDBs_Head.GetValue("DocEntry", 0))
                        objMain.objUtilities.RefreshDatasourceFromDB(FormUID, objForm.DataSources.DBDataSources.Item("@VSP_FLT_TYRMTNC_C1"), "DocEntry", oDBs_Details2.GetValue("DocEntry", 0))
                        objMain.objUtilities.RefreshDatasourceFromDB(FormUID, objForm.DataSources.DBDataSources.Item("@VSP_FLT_TYRMTNC_C2"), "DocEntry", oDBs_Details2.GetValue("DocEntry", 0))
    ...
    Sub MenuEvent(ByRef pVal As SAPbouiCOM.MenuEvent, ByRef BubbleEvent As Boolean)
        Try
            If pVal.MenuUID = "VSP_FLT_TYRMTNC" And pVal.BeforeAction = False Then
                Me.CreateForm()
                Me.SetDefault(objForm.UniqueID)
