Public Class clsDeliveryBatchFile
                ...
                Case SAPbouiCOM.BoEventTypes.et_ITEM_PRESSED
                    ...
                    If pVal.ItemUID = "1" And pVal.BeforeAction = False And pVal.FormMode = SAPbouiCOM.BoFormMode.fm_OK_MODE Then
                        ...
                        If oRsChkRestriction.RecordCount > 0 Then
                            objBatchFile = objMain.objApplication.Forms.GetForm("42", objMain.objApplication.Forms.ActiveForm.TypeCount)
                            objBatchFileMatrix = objBatchFile.Items.Item("5").Specific
