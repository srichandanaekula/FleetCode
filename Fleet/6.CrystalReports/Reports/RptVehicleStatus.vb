...
Public Class RptVehicleStatus
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Fleet.RptVehicleStatus.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedRptVehicleStatus
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As RptVehicleStatus = New RptVehicleStatus
        rpt.Site = Me.Site
        Return rpt
    End Function
